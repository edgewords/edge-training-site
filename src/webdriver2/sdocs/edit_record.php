			...
			<form id="FindRecord">
				...
				<table class="formTable">
                	...
                	<tr>
                    	<td></td>
                        <td>
                                <a href="#" onclick="javascript:findRecord();return false;" class="orange-button">Submit</a>
                        </td>
                    </tr>
                </table>
            </form>
			<form id="EditRecord">
				<h2> Edit - Must change Password or Cancel</h2>
				<table class="formTable">
                	<tr>
					...
					<tr>
                    	<td>House Name or Number<span class="red"></span>
                    	</td>
                        <td>
                                <input class="formInput" id="house" type="text" />
                        </td>
                    </tr>
					<tr>
                        ...
                        <td>
                                <input class="formInput" id="adl1" type="text" />
                        </td>
                    </tr>
					<tr>
                    	<td>City or Town<span class="red"></span>
                    	</td>
                        <td>
                                <input class="formInput" id="town" type="text" />
                        </td>
                    </tr>
					<tr>
                    	<td>County<span class="red"></span>
                    	</td>
                        <td>
                                <input class="formInput" id="county" type="text" />
                        </td>
                    </tr>
					<tr>
                    	<td>Post Code<span class="red"></span>
                    	</td>
                        <td>
                                <input class="formInput" id="postcode" type="text" />
                        </td>
                    </tr>
					<tr>
                	...
                	<tr>
                    	<td></td>
                        <td>
                                <a href="#" onclick="javascript:editRecord();return false;" class="orange-button">Submit</a>
                                <a href="#" onclick="javascript:clearEditRecord();return false;" class="orange-button">Clear</a>
