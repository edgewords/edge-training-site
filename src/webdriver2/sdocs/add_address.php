...
?>
        ...
        <div id="main-page">
            ...
            <div id="right-column">
			<h1>Add an address to an existing record in the Database</h1>
			<form id="AddAddress">
				<h2> Add Address </h2>
				<table class="formTable">
                	...
                	<tr>
                    	<td></td>
                        <td>
                                <a href="#" onclick="javascript:addAddress();return false;" class="orange-button">Submit</a>
                                <a href="#" onclick="javascript:clearAddAddress();return false;" class="orange-button">Clear</a>
